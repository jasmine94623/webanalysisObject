...
for( var key in sensorDatas ) {
    if(key == "植物高度"){
        ...
        console.log(sensorDatas[key].time["上月"].genVal);    
        continue;
    }
    for(i = 0; i < 7;i++){
...
function initialChart(){
    ...
    data:{
        ...
        datasets:[{ 
            ...
            borderColor: 'gray',
            fill: false,
            data: sensorDatas["環境溫度"].time["上週"].genVal,
        },{ 
            type:'line',
            label: '臨界值溫度',
            yAxisID: 'y-axis-1',
            ...
            borderColor: '#fc4757',
            fill: false,
            data: sensorDatas["環境溫度"].time["上週"].topVal,
            pointStyle: 'dash',
            beginAtZero: true,
        },{
            type:'bar',
            ...
            borderColor: 'green',
            fill: false,
            data: sensorDatas["植物高度"].time["上週"].genVal,
